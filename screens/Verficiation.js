...
export default class Verficiation extends Component {
  data = async () => {
    ...
    Phone_Number : "${
      this.props.route.params.item.phone_number
    }"
    Did_Patient_Elect_To_Be_Private_YesNo: "${
      this.props.route.params.item.private_patient == "1"
        ? "Yes"
        : "No"
    }"
    ...
    Previously_Claimed_For_Illness_YesNo: "${
                  this.props.route.params.item.related == "1"
                    ? "Yes"
                    : "No"
                }"
    ...
    Admission_IsResult_Of_Accident_YesNo: "${
                  this.props.route.params.item.accident =="1"
                    ? "Yes"
                    : "No"
                }"
    ts_Date_of_Accident: "${
                  this.props.route.params.item.accidentDate !=""
                    ? this.props.route.params.item.accidentDate
                    : "1900-01-01"
                }"
    ...
    Was_Accident_Injury_Fault_of_Another_Party_YesNo: "${
                  this.props.route.params.item.anotherParty =="1"
                    ? "Yes"
                    : "No"
                }"
    ...
    Are_You_Claiming_Expenses_Via_PIAB_YesNo: "${
                  this.props.route.params.item.personalBoard =="1"
                    ? "Yes"
                    : "No"
                }"
    Are_You_Claiming_Expenses_Via_Solicitor_YesNo: "${this.props.route.params.item.solictorExpense =="1"
                                ? "Yes"
                                : "No"
                            }"
    ...
    Patient_Signature: "${
      this.props.route.params.item.drawing
    }"
    ts_Date_Patient_Signature: "${moment(new Date()).format("YYYY-MM-DD HH:mm")}"
...
this.props.route.params.item.confirmed == "1" ? "Yes" : "No"
    ...
    Worked_In_Covid19_Healthcare_facility_abroad_YesNo: "${
      this.props.route.params.item.healthcare == "1"
        ? "Yes"
        : "No"
    }"
    hospitalId : 1
